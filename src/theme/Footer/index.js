            ...
            <div>
                <div className="lg:flex">
                    <div className="w-full lg:w-1/3 pb-12">
                        <a href='https://bonusblock.io' target='_blank'>
                    ...
                    <div className="w-full lg:w-2/3 grid grid-cols-2 md:grid-cols-3 gap-y-8 gap-x-8">
                        ...
                        <div className="flex-shrink-0 flex flex-col space-y-3">
                            ...
                            <div>
                                <Link className="caption" href="https://discord.gg/SHsBSZUAnN">
                                    Discord
                                </Link>
                            </div>
                            <div>
                                <Link className="caption" href="https://www.reddit.com/r/BonusBlock">
                                    Reddit
                                </Link>
                            </div>
                        </div>
