            ...
            <div>
                <div className="lg:flex">
                    ...
                    <div className="w-full lg:w-2/3 grid grid-cols-2 md:grid-cols-3 gap-y-8 gap-x-8">
                        ...
                        <div className="flex-shrink-0 flex flex-col space-y-3">
                            <h4 className="caption font-bold">Blockchain</h4>
                            <div>
                                <Link className="caption" href="https://explorer-testnet.bonusblock.io">
                                    Testnet Explorer
                                </Link>
                            </div>
                            <div>
                                <Link className="caption" href="https://faucet.bonusblock.io">
                                    Testnet Faucet
                                </Link>
                            </div>
                        </div>
